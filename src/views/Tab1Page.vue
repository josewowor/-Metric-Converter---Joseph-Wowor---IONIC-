      ...
      <div class="header-wrapper">
        <ion-card class="header-card">
          <ion-card-header>
            ...
            <ion-card-subtitle class="subtitle">By: Joseph Wowor</ion-card-subtitle>
          </ion-card-header>
        </ion-card>
      </div>
...
.subtitle {
  color: #b71c1c; /* Darker red for the subtitle */
}
...
h3 {
  color: #d32f2f; /* Red for result title */
}
...
ion-input::part(native) {
  border-bottom: 1px solid #d32f2f; /* Red bottom border for input */
}

ion-select::part(native) {
  border-bottom: 1px solid #d32f2f; /* Red bottom border for select */
}

ion-select .select-icon {
  color: #d32f2f; /* Red color for select icon */
}
</style>
